...
- 時區：Asia/Taipei。自然運作窗口為 `2026-09-11 16:35:00+08:00` 至 `19:34:44+08:00`；durable telemetry 的最後可觀察事件是 `19:24:02+08:00`，截止後沒有把沉默當成新成功。
...
| natural failure / recovery | 18:43 窗口有 1 attachment error，之後 3 success；checkpoint readback 為零 in-flight、零 unknown；Hermes active call/result IDs 成對且有序 | error 與後續 success 沒有足夠 correlation 可證明是同一 logical request |
...
This archive fixes the evidence boundary for 2026-09-11 in Asia/Taipei. The natural window ends at `19:34:44+08:00`; the last durable telemetry event available at the readback was `19:24:02+08:00`. It records public source e5, stable-v0.1.9, exact CI/release identities, focused tests, 112 observed chat records, the 17:49–17:57 suspicion window, and the 18:42–18:50 recovery window.
