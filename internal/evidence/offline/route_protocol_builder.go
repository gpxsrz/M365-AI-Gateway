...
type ProtocolClassification = core.ProtocolClassification
type RouteProtocolCase = core.RouteProtocolCase
type RouteProtocolDescriptor = core.RouteProtocolDescriptor
type RouteProtocolCaptureV1 = core.RouteProtocolCaptureV1
type RouteProtocolObservationV1 = core.RouteProtocolObservationV1
type RouteProtocolCapabilityRecordV1 = core.RouteProtocolCapabilityRecordV1
type RouteProtocolRecordV1 = core.RouteProtocolRecordV1
type RouteProtocolMatrixEntryV1 = core.RouteProtocolMatrixEntryV1
type RouteProtocolFailureEntryV1 = core.RouteProtocolFailureEntryV1
type RouteProtocolEvidenceSetV1 = core.RouteProtocolEvidenceSetV1

const (
	RouteProtocolCaptureSchemaV1     = core.RouteProtocolCaptureSchemaV1
	RouteProtocolObservationSchemaV1 = core.RouteProtocolObservationSchemaV1
	RouteProtocolEvidenceSetSchemaV1 = core.RouteProtocolEvidenceSetSchemaV1
	MaxRouteProtocolCaptureBytes     = core.MaxRouteProtocolCaptureBytes
	ProtocolExposedAndSupported      = core.ProtocolExposedAndSupported
	RouteProtocolCaseSuccess         = core.RouteProtocolCaseSuccess
	RouteProtocolCaseUnknownRoute    = core.RouteProtocolCaseUnknownRoute
	RouteProtocolCaseDisabledRoute   = core.RouteProtocolCaseDisabledRoute
	RouteProtocolCaseUpstreamEmpty   = core.RouteProtocolCaseUpstreamEmpty
)

var allowedRouteProtocolCaptureFields = map[string]struct{}{
	"schema": {}, "case_id": {}, "run": {}, "requested_model": {}, "top_level_model": {},
	"canonical_route": {}, "resolved_tone": {}, "protocol": {}, "endpoint_path": {}, "auth_mode": {},
	"request_id_observed": {}, "security_headers_observed": {}, "http_status": {}, "basic_text_delivered": {},
	"reasoning_effort_applied": {}, "reasoning_effort_ignored": {}, "upstream_attempts": {}, "route_switches": {},
	"cross_account_resends": {}, "meaningful_upstream_event": {}, "failure_code": {},
}
...
func CaptureRouteProtocol(raw []byte, descriptor RouteProtocolDescriptor, binding CaptureBinding) (RouteProtocolRecordV1, error) {
	...
	observation := RouteProtocolObservationV1{
		Schema: RouteProtocolObservationSchemaV1, ObservationID: fmt.Sprintf("%s.%s.%s.%d", capture.RequestedModel, capture.Protocol, capture.CaseID, capture.Run),
		CaseID: capture.CaseID, Run: capture.Run, RequestedModel: capture.RequestedModel, TopLevelModel: capture.TopLevelModel,
		CanonicalRoute: capture.CanonicalRoute, ResolvedTone: capture.ResolvedTone, Protocol: capture.Protocol,
		EndpointPath: capture.EndpointPath, AuthMode: capture.AuthMode, RequestIDObserved: capture.RequestIDObserved,
		SecurityHeadersObserved: capture.SecurityHeadersObserved, Classification: ProtocolExposedAndSupported,
		HTTPStatus: capture.HTTPStatus, BasicTextDelivered: capture.BasicTextDelivered,
		ReasoningEffortApplied: capture.ReasoningEffortApplied, ReasoningEffortIgnored: capture.ReasoningEffortIgnored,
		UpstreamAttempts: capture.UpstreamAttempts, RouteSwitches: capture.RouteSwitches,
		CrossAccountResends: capture.CrossAccountResends, MeaningfulUpstreamEvent: capture.MeaningfulUpstreamEvent,
	...
	for _, capabilityID := range capabilityIDs {
		record, err := routeProtocolCapabilityRecord(capabilityID, observationSHA256, descriptor, binding)
		if err != nil {
			return RouteProtocolRecordV1{}, err
		}
		capabilities = append(capabilities, record)
	}
	return RouteProtocolRecordV1{ObservationJSON: append(json.RawMessage(nil), canonicalObservation...), ObservationSHA256: observationSHA256, Capabilities: capabilities, Observation: observation}, nil
}
...
func routeProtocolCapabilityRecord(capabilityID, observationSHA256 string, descriptor RouteProtocolDescriptor, binding CaptureBinding) (RouteProtocolCapabilityRecordV1, error) {
	...
	return RouteProtocolCapabilityRecordV1{
		...
		EvidenceSHA256: built.EvidenceSHA256,
